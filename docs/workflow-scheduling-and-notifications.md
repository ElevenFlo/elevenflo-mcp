...
| Deep Research / company knowledge | Potential research path where available. Verify the current ElevenFlo connection before relying on it; do not use it for write or modify claims. |
